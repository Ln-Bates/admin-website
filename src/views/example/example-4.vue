<template>
    <simple-view>
        <el-collapse v-model="activeName"
                     accordion>
            <el-collapse-item title="时间选择"
                              name="1">
                <date-picker v-model="datePickerModel" />
                {{datePickerModel}}
            </el-collapse-item>
            <el-collapse-item title="时间区间"
                              name="2">
                <date-range v-model="dateRangeModel" />
                {{dateRangeModel}}
            </el-collapse-item>
            <el-collapse-item title="单选"
                              name="3">
                <form-radio :options="options"
                            v-model="formRadioModel" />
            </el-collapse-item>
            <el-collapse-item title="下拉"
                              name="4">
                <form-select :options="options"
                             v-model="formSelectModel" />
            </el-collapse-item>
            <el-collapse-item title="多选"
                              name="5">
                <form-checkbox v-model="formCheckboxModel"
                               :options="options" />
                {{formCheckboxModel}}
            </el-collapse-item>
            <el-collapse-item title="开关"
                              name="6">
