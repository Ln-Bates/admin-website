<template>
  <simple-view>
    ...
    <drawer-detail v-model="showDrawerDetail"
                   :data="data"
    ...
    <simple-dialog v-model="showDialog" :handle-click="dialogClick">
      <div>
        这是主题
      </div>
    </simple-dialog>
        ...
        detailModel: [
          {
            title: '普通详情1',
            list: [
              detailHelper.default('联系人', 'prop1'),
            ],
            span: 24
          },
          {
